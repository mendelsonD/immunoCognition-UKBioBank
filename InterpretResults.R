    ...
    for(file in fileNames){
      ...
      fileNameAffix <- "_p"
       ...
       if(pCor == TRUE){
        ...
        outputDf_p_cor <- rbind(outputDf_p_cor, outputDF_keyYM_sig)
        } 
    }
...
path <- "/projects/def-mlepage/mend/Analyses/immunoCognition-UKBioBank/Outputs/Summary/Med_C/Raw" # path to raw mediation output summary files
fileNames <- c("UKBB_med_C_results_CRPWeights_05_05_2022","UKBB_excludingDx_med_C_results_05_06_2022","UKBB_excludingSSRI_med_C_results_05_06_2022","UKBB_oldestTert_med_C_results_05_06_2022","UKBB_onlyDx_med_C_results_05_06_2022","UKBB_onlyMedUsers_med_C_results_05_06_2022","UKBB_youngestTert_med_C_results_05_06_2022", "UKBB_NoSSRINoDx_med_C_results_05_09_2022", "UKBB_NoMedNoDx_med_C_results_05_08_2022", "UKBB_noMed_med_C_results_05_08_2022") # name of summary mediation outcome files
...
getPMed(path = path, fileNames = fileNames, keyMediators = keyMediators_1, keyCognition = keyCognition, pCor = T, sigOnly = F, alpha = .1, outputAffix = "round1") # for round 1, general brain metrics 
...
getPMed(path = path, fileNames, keyMediators = keyMediators_2, keyCognition = keyCognition, pCor = T, sigOnly = F, alpha = .1, outputAffix = "round2") # for round 2, specific brain regions
